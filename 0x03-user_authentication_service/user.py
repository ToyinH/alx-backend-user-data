...
class User(Base):
    ...
    Attributes:
        ...
        email (str): A non-nullable string representing
        the email address of the user.
        hashed_password (str): A non-nullable
        string representing the hashed password of the user.
        session_id (str): A nullable string representing the
